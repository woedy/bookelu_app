                        ...
                        children: [
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Verification", style: TextStyle(fontSize: 60, fontFamily: "Fontspring", height: 1),),
                                SizedBox(
                                  height: 15,
                                ),

                                Text("One more step! Let's verify your email.", style: TextStyle(fontSize: 32, ),),
                                SizedBox(
                                  height: 15,
                                ),
                          ...
                          InkWell(
                            onTap: () {
                              setState(() {
                                _futureVerifyEmail = verifyUserEmail(email_token, widget.email);
